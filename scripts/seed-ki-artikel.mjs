...
const blogPost = {
  slug: 'ki-tools-unternehmen-implementieren',
  title: 'Wie man KI-Tools in Unternehmen erfolgreich implementiert',
  excerpt: 'Ein praxisorientierter Leitfaden für die erfolgreiche Einführung von KI-Lösungen in Ihrem Unternehmen – von der Strategieentwicklung bis zur Mitarbeiterschulung.',
  content: `## Einleitung
...
- Lesen Sie unseren Artikel über [DSGVO-konforme KI-Strategien](/blog/ki-im-unternehmen-einfuehren)`,
  author: 'Redaktion',
  category: 'Praxis',
  readTime: '12 Min.',
  imageUrl: '/images/feature-analytics.webp',
  metaTitle: 'KI-Tools in Unternehmen implementieren - Praxisleitfaden 2026',
  metaDescription: 'Schritt-für-Schritt-Anleitung zur erfolgreichen Einführung von KI-Tools in Ihrem Unternehmen. Von der Strategieentwicklung bis zur Mitarbeiterschulung.',
  isPublished: true,
    ...
    if (existing.length > 0) {
      ...
      await connection.execute(
        `UPDATE blog_posts SET 
          ...
          readTime = ?, imageUrl = ?, metaTitle = ?, metaDescription = ?,
          isPublished = ?, publishedAt = ?, updatedAt = NOW()
        WHERE slug = ?`,
        [
          blogPost.title, blogPost.excerpt, blogPost.content, blogPost.author,
          blogPost.category, blogPost.readTime, blogPost.imageUrl,
          blogPost.metaTitle, blogPost.metaDescription, blogPost.isPublished,
          blogPost.publishedAt, blogPost.slug
        ]
      );
      ...
      await connection.execute(
        `INSERT INTO blog_posts 
          (slug, title, excerpt, content, author, category, readTime, imageUrl, 
           metaTitle, metaDescription, isPublished, publishedAt)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          blogPost.slug, blogPost.title, blogPost.excerpt, blogPost.content,
          blogPost.author, blogPost.category, blogPost.readTime, blogPost.imageUrl,
          blogPost.metaTitle, blogPost.metaDescription, blogPost.isPublished,
